                    ...
                    <div class="card-header">
                        <div class="card-header">
                            <h2 style="text-align: center;">
                                <strong>Ringkasan Data Pengajuan
                                    {{-- Tahun {{ date('Y') }} --}}
                                </strong>
                            </h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-info">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(0)]) }}">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-secondary">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(11)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-warning">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(1)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-primary">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(2)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-danger">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(4)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-success">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(5)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-danger">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(8)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-info">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(9)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
                            ...
                            @if (in_array($userLevel, [1, 2, 3]))
                                <div class="col-xl-3 col-md-6 col-12">
                                    <div class="card bg-gradient-directional-warning">
                                        <div class="card-content">
                                            <div class="card-body">
                                                <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(10)]) }}">
                                                    <div class="media d-flex">
                                                        <div class="media-body text-white text-left">
                                                        ...
                                                        <div class="align-self-center">
                                                            <i
                                                                class="icon-credit-card text-white font-large-2 float-right"></i>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="card bg-gradient-directional-success">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <a href="{{ route('data.pengajuan', ['status' => Crypt::encrypt(3)]) }}">
                                                <div class="media d-flex">
                                                    <div class="media-body text-white text-left">
