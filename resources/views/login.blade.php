                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}"
                                            ...
                                            {{-- CAPTCHA: pertambahan angka --}}
                                            <fieldset class="form-group position-relative has-icon-center">
                                                <label>Berapa hasil dari {{ $angka1 }} +
                                                    {{ $angka2 }}?</label>
